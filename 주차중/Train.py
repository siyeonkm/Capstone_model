...
parser.add_argument('--dataset_path', type=str, default='/home/sunkyung/Downloads/stop/dataset/', help='directory of data')
parser.add_argument('--exp_dir', type=str, default='/home/sunkyung/Downloads/stop/log', help='directory of log')
...
print("report the training process")
